...
/*Klon von aruZeichne => zeichnet nur den Rotanteil der Pixel*/

aruZeichnerR::aruZeichnerR(unsigned char* zeichenFlaeche, int hoehe, int breite)
{
...
void aruZeichnerR::ZeichneKreis(int iXm, int iYm, int iRadius)
{
...
void aruZeichnerR::ZeichneLinie(int p1x, int p1y, int p2x, int p2y)
{
...
void aruZeichnerR::SetzeFarbe(unsigned char r, unsigned char g, unsigned char b)
{
    m_RGB_R = r;
    m_RGB_G = g;
    m_RGB_B = b;
...
void aruZeichnerR::ZeichneDreieck(int p1x, int p1y, int p2x, int p2y, int p3x, int p3y)
{
...
void aruZeichnerR::ZeichneRechteck(int x1, int y1, int x2, int y2)
{
...
void aruZeichnerR::ZeichneGeradesDreieck(int iXL, int iYLo, int iYLu, int iXR, int iYRo, int iYRu)
{
...
void aruZeichnerR::ZeichneTrapezSenkrecht(int iMinX, int iMaxX, int iMinYu, int iMaxYu, int iMinYo, int iMaxYo)
{
...
void aruZeichnerR::HintergrundZeichnen(unsigned char r, unsigned char g, unsigned char b)
{
...
void aruZeichnerR::logSchreiben(const char* msg, ...)
{
    FILE *Logbuch;
