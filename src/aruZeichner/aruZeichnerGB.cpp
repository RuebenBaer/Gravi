...
/*Klon von aruZeichne => zeichnet nur den Grün- und Blauanteil der Pixel*/

aruZeichnerGB::aruZeichnerGB(unsigned char* zeichenFlaeche, int hoehe, int breite)
{
...
void aruZeichnerGB::ZeichneKreis(int iXm, int iYm, int iRadius)
{
...
void aruZeichnerGB::ZeichneLinie(int p1x, int p1y, int p2x, int p2y)
{
...
void aruZeichnerGB::SetzeFarbe(unsigned char r, unsigned char g, unsigned char b)
{
    m_RGB_R = r;
    m_RGB_G = g;
    m_RGB_B = b;
...
void aruZeichnerGB::ZeichneDreieck(int p1x, int p1y, int p2x, int p2y, int p3x, int p3y)
{
...
void aruZeichnerGB::ZeichneRechteck(int x1, int y1, int x2, int y2)
{
...
void aruZeichnerGB::ZeichneGeradesDreieck(int iXL, int iYLo, int iYLu, int iXR, int iYRo, int iYRu)
{
...
void aruZeichnerGB::ZeichneTrapezSenkrecht(int iMinX, int iMaxX, int iMinYu, int iMaxYu, int iMinYo, int iMaxYo)
{
...
void aruZeichnerGB::logSchreiben(const char* msg, ...)
{
    FILE *Logbuch;
